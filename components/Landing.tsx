  ...
  useEffect(() => {
    ...
    function init(): () => void {
      ...
      function tick(now: number) {
        ...
        // ── Cinematic "About" paragraph ──
        // Task 1 fix: gentler vertical travel (-60px vs -120px) and a
        // milder tilt so the text never rides out of / gets clipped by its
        // container as it enters and exits.
        const yVal = -60 * Math.min(1, window.scrollY / 1000);
        ...
        cinematicInner.style.transform = `rotateX(12deg) translateY(${yVal}px) translateZ(0px)`;
  ...
  return (
    <>
      ...
      <main id="main-content">
          ...
          >
            ...
            <div className="hero-grid-bottom">
              <div className="hero-desc" id="hero-desc">
                <p>
                  Health doesn&rsquo;t fail people at the moment of crisis. It
                  fails them in the silent days before it. Arogyasetu fuses
                  web-based self-report, real-time environmental exposure, and a
                  trust-scored mutual-aid network into one closed predictive
                  loop &mdash; delivering micro-interventions and discreet Care
                  Pings before crisis.
                </p>
              </div>
              <div
        ...
        {/* SECTION 1.5: Cinematic "About" Parallax Paragraph */}
        <div id="cinematic-section">
          <div id="cinematic-inner">
            <h2>
              A privacy-first Predictive Community Health Operating System.
              Arogyasetu turns any desktop browser into a personal and community
              health safety net. It detects rising vulnerability windows from
              your own signals and your environment, then automatically delivers
              AI micro-interventions and discreet Care Pings to matched
              neighbors, peers, and volunteers &mdash; before crisis, never
              after.
            </h2>
          </div>
        </div>
      ...
      {/* SECTION 3+: Cinematic "ENTER THE LOOP" film for Arogyasetu */}
      <ArogyaFilm />
    </>
  );
}
